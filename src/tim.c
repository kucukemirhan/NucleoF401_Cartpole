...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM10_MspInit 0 */
    ...
    PB8     ------> TIM10_CH1
    */
    GPIO_InitStruct.Pin = InputCapture1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM10;
    HAL_GPIO_Init(InputCapture1_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM11_MspInit 0 */
    ...
    PB9     ------> TIM11_CH1
    */
    GPIO_InitStruct.Pin = InputCapture2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM11;
    HAL_GPIO_Init(InputCapture2_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM10_MspDeInit 0 */
    ...
    PB8     ------> TIM10_CH1
    */
    HAL_GPIO_DeInit(InputCapture1_GPIO_Port, InputCapture1_Pin);
  ...
  /* USER CODE END TIM11_MspDeInit 0 */
    ...
    PB9     ------> TIM11_CH1
    */
    HAL_GPIO_DeInit(InputCapture2_GPIO_Port, InputCapture2_Pin);
